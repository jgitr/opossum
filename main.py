...
import os
os.chdir('/home/tobias/github_repositories/predictiveanalytics')


from SimulateData import UserInterface
from plots import propensity_score_plt, all_treatment_effect_plt, single_treatment_effect_plt, output_difference_plt 
import numpy as np
