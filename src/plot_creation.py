...
## positive negative
#u = UserInterface(10000,10, seed=15)
#u.generate_treatment(random_assignment=False, treatment_option_weights = [0.5, 0, 0.5, 0])
#y, X, assignment, treatment = u.output_data(False)
#
#treatment_list.append(treatment)
#assignment_list.append(assignment)
...
## all mixed
#u = UserInterface(10000,10, seed=15)
#u.generate_treatment(random_assignment=False, treatment_option_weights = [0.2, 0.5, 0.1, 0.2])
#y, X, assignment, treatment = u.output_data(False)
#
#treatment_list.append(treatment)
#assignment_list.append(assignment)
...
## 80% no effect
#u = UserInterface(10000,10, seed=15)
#u.generate_treatment(random_assignment=False, treatment_option_weights = [0, 0.2, 0, 0.8])
#y, X, assignment, treatment = u.output_data(False)
#
#treatment_list.append(treatment)
#assignment_list.append(assignment)
